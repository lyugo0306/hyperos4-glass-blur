...
.DESCRIPTION
    One-click build for os4-glass-blur v6.0. Requires:
      - JDK (javac/jar)
...
$OutName       = 'os4-glass-blur-v6.0.apk'
# ---------------------------------------
...
# Compile every Java source in app/src so new Activities/helpers are not
# accidentally omitted from hand-maintained javac arguments.
